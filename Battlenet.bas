...
Public Const ICON_WAR3     As Integer = 19 'Warcraft 3 Now added.
Public IniUser As String, IniPass As String, IniServer As String, TheChannel As String, IdleTick As Long 'declares variables for loading ini and misc use
Public IdleMessage As String, IdleInterval As String
...
Public Sub Connect(ctlSock As Control, Optional strPort = 6112)
    ...
    IdleMessage = GetStuff("Idle", "Message")
    IdleInterval = GetStuff("Idle", "Interval")
    If GetStuff("Idle", "Idle") = "True" Then
        frmBot.AntiIdle.Enabled = True
    Else
        frmBot.AntiIdle.Enabled = False
    End If
...
frmLogin.Show
frmLogin.txtlogin = IniUser
frmLogin.txtpassword = IniPass
        End If
End Sub
